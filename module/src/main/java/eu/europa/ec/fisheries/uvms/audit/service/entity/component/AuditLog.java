 ...
 */
package eu.europa.ec.fisheries.uvms.audit.service.entity.component;
...
public class AuditLog implements Serializable {
	...
	public String toString() {
		return "AuditEntry [id=" + id + ", username=" + username + ", operation=" + operation + ", objectType="
				+ objectType + ", timestamp=" + timestamp + ", affectedObject=" + affectedObject + "]";
	}
